...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function dayshow(e, data) {
	        // THIS IS WHERE DISPLAYS THE POPUP WITH THE INFO READY TO DELETE OR EDIT
            if (data == undefined) {
                data = getdata($(this));
            }
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    ...
                    $("#bbit-cs-what").html(data[1] + ' - ' + data[10]);
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div class="subj"><input class="subj-rad" type="radio" name="bbit-cal-what" value="Personal Time Off" checked>Personal Time Off</div></div></div>');
                ...
                calbutton.click(function(e) {
                    ...
                    option.isloading = true;
                    var what = $("input[name=bbit-cal-what]:checked").val();
            ...
            var dateshow = CalDateShow(start, end, !isallday, false);			
