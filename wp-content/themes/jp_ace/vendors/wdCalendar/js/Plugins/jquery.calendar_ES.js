    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div class="subj"><input class="subj-rad" type="radio" name="bbit-cal-what" value="Tiempo Personal" checked>Tiempo Personal</div></div></div>');
